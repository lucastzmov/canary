...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ text = "Looking to buy or sell something?" },
	{ text = "Best prices in town!" },
	{ text = "I trade all kinds of goods." },
}
...
-- Mensagem de saudação e despedida
...
-- Nenhuma função de diálogo especial necessária
...
-- Ao inspecionar item (opcionalmente vazio)
